...
**Example for ERC-20 USDTExample for ERC-20 USDT**:

```text
ethereum:0x742d35Cc6634C0532925a3b8D4C9db96590f6C7E?network=ETHethereum:0x742d35Cc6634C0532925a3b8D4C9db96590f6C7E?network=ETH
```

**Example for TTRC-20 USDT**:

```text
tron:TXYZ1234567890...?network=TRXtron:TXYZ1234567890...?network=TRX
```
...
## Integration FlowIntegration Flow
