...
|----------|-------------|-----------|
| **Common** | Balance, configuration, health, webhook settings | [`/health`](/api-reference/common#get-health) [`/balance`](/api-reference/common#get-balance) [`/callback-url`](/api-reference/common#get-callback-url) |
| **Customers** | Customer onboarding and KYC verification | [`POST /customer/create`](/api-reference/customers#post-customercreate) [`GET /customer/detail`](/api-reference/customers#get-customerdetail) [`GET /customer/list`](/api-reference/customers#get-customerlist) |
| **Virtual Accounts** | Fiat virtual accounts for receiving payments | [`POST /virtual-account/create`](/api-reference/virtual-accounts#post-virtual-accountcreate) [`GET /virtual-account/list`](/api-reference/virtual-accounts#get-virtual-accountlist) [`GET /virtual-account/detail`](/api-reference/virtual-accounts#get-virtual-accountdetail) |
